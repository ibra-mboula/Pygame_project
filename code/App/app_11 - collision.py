...
#  créer une fonction pour créer des météores
...
""" ------------------Meteor--------------------------------------- """  
#créer un timer pour faire apparaître les météorites  
...
laser_sound = pygame.mixer.Sound("code/sounds/laser.ogg") # pour charger le son du laser
explosion_sound = pygame.mixer.Sound("code/sounds/explosion.wav") # pour charger le son de l'explosion
background_sound = pygame.mixer.Sound("code/sounds/music.wav") # pour charger le son de l'explosion
background_sound.play(loops = -1) # pour jouer le son en boucle
...
while True: # boucle infinie
  ...
  for laser_rect in laser_list:
    for meteor_tuple in meteor_List:
      ...
      if laser_rect.colliderect(meteor_tuple[0]):
        ...
        print("you got 1 meteor")
        
  
  #si l'événement est de type meteor_timer, créer un météorite et l'ajouter à la liste des météorites
  ...
  #  faire déplacer les météorites vers le bas
